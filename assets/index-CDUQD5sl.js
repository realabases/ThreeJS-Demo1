...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function Ql(){return new qn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Fa(),fragmentShader:`
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function tc(){return new qn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Fa(),fragmentShader:`
...
#define LOW_PRECISION`),t}function Av(n){let t="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Jc?t="SHADOWMAP_TYPE_PCF":n.shadowMapType===Wu?t="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===gn&&(t="SHADOWMAP_TYPE_VSM"),t}function Pv(n){let t="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Ji:case Qi:t="ENVMAP_TYPE_CUBE";break;case zs:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Rv(n){let t="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Qi:t="ENVMAP_MODE_REFRACTION";break}return t}function Lv(n){let t="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case ya:t="ENVMAP_BLENDING_MULTIPLY";break;case _d:t="ENVMAP_BLENDING_MIX";break;case vd:t="ENVMAP_BLENDING_ADD";break}return t}function Dv(n){const t=n.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:i,maxMip:e}}function Iv(n,t,e,i){const r=n.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=Av(e),c=Pv(e),h=Rv(e),u=Lv(e),p=Dv(e),m=xv(e),g=Mv(s),x=r.createProgram();let f,d,S=e.glslVersion?"#version "+e.glslVersion+`
