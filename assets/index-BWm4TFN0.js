...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function ec(){return new qn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ka(),fragmentShader:`
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function nc(){return new qn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ka(),fragmentShader:`
...
`)}function Mv(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Er).join(`
...
`].filter(Er).join(`
`)),o=va(o),o=dc(o,e),o=pc(o,e),a=va(a),a=dc(a,e),a=pc(a,e),o=fc(o),a=fc(a),e.isRawShaderMaterial!==!0&&(S=`#version 300 es
