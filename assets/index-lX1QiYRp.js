...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function nc(){return new qn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ba(),fragmentShader:`
...
`].filter(Er).join(`
`)),o=_a(o),o=dc(o,e),o=pc(o,e),a=_a(a),a=dc(a,e),a=pc(a,e),o=fc(o),a=fc(a),e.isRawShaderMaterial!==!0&&(S=`#version 300 es
